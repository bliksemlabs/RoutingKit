...
build/geo_position_to_node_rtree.o: include/routingkit/RTree.h include/routingkit/constants.h include/routingkit/geo_dist.h include/routingkit/geo_position_to_node.h include/routingkit/geo_position_to_node_rtree.h src/geo_position_to_node_rtree.cpp generate_make_file
	@mkdir -p build
	$(CC) $(CFLAGS)  -c src/geo_position_to_node_rtree.cpp -o build/geo_position_to_node_rtree.o

build/test_rtree_streetside_preference.o: include/routingkit/RTree.h include/routingkit/constants.h include/routingkit/geo_position_to_node.h include/routingkit/geo_position_to_node_rtree.h include/routingkit/inverse_vector.h include/routingkit/min_max.h include/routingkit/permutation.h include/routingkit/sort.h include/routingkit/timer.h src/test_rtree_streetside_preference.cpp generate_make_file
	@mkdir -p build
	$(CC) $(CFLAGS)  -c src/test_rtree_streetside_preference.cpp -o build/test_rtree_streetside_preference.o
...
bin/test_rtree_streetside_preference: build/geo_position_to_node.o build/geo_position_to_node_rtree.o build/test_rtree_streetside_preference.o build/timer.o
	@mkdir -p bin
	$(CC) $(LDFLAGS) build/geo_position_to_node.o build/geo_position_to_node_rtree.o build/test_rtree_streetside_preference.o build/timer.o -lm  -o bin/test_rtree_streetside_preference

lib/libroutingkit.a: build/bit_select.o build/bit_vector.o build/buffered_asynchronous_reader.o build/contraction_hierarchy.o build/customizable_contraction_hierarchy.o build/file_data_source.o build/geo_position_to_node.o build/geo_position_to_node_rtree.o build/graph_util.o build/id_mapper.o build/nested_dissection.o build/osm_decoder.o build/osm_graph_builder.o build/osm_profile.o build/osm_simple.o build/protobuf.o build/timer.o build/vector_io.o
	@mkdir -p lib
	$(AR) rcs lib/libroutingkit.a build/bit_select.o build/bit_vector.o build/buffered_asynchronous_reader.o build/contraction_hierarchy.o build/customizable_contraction_hierarchy.o build/file_data_source.o build/geo_position_to_node.o build/geo_position_to_node_rtree.o build/graph_util.o build/id_mapper.o build/nested_dissection.o build/osm_decoder.o build/osm_graph_builder.o build/osm_profile.o build/osm_simple.o build/protobuf.o build/timer.o build/vector_io.o

lib/libroutingkit.so: build/bit_select.o build/bit_vector.o build/buffered_asynchronous_reader.o build/contraction_hierarchy.o build/customizable_contraction_hierarchy.o build/file_data_source.o build/geo_position_to_node.o build/geo_position_to_node_rtree.o build/graph_util.o build/id_mapper.o build/nested_dissection.o build/osm_decoder.o build/osm_graph_builder.o build/osm_profile.o build/osm_simple.o build/protobuf.o build/timer.o build/vector_io.o
	@mkdir -p lib
	$(CC) -shared $(LDFLAGS) build/bit_select.o build/bit_vector.o build/buffered_asynchronous_reader.o build/contraction_hierarchy.o build/customizable_contraction_hierarchy.o build/file_data_source.o build/geo_position_to_node.o build/geo_position_to_node_rtree.o build/graph_util.o build/id_mapper.o build/nested_dissection.o build/osm_decoder.o build/osm_graph_builder.o build/osm_profile.o build/osm_simple.o build/protobuf.o build/timer.o build/vector_io.o $(OMP_LDFLAGS) -lm -lz -pthread -o lib/libroutingkit.so
